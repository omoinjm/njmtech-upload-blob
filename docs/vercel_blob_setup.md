...
URL Source: https://vercel.com/docs/vercel-blob/server-upload?language=py
...
Vercel Blob is available on [all plans](https://vercel.com/docs/plans)

Those with the [owner, member, developer](https://vercel.com/docs/rbac/access-roles#owner,%20member,%20developer-role) role can access this feature
...
Vercel has a [4.5 MB request body size limit](https://vercel.com/docs/functions/runtimes#request-body-size) on Vercel Functions. If you need to upload larger files, use [client uploads](https://vercel.com/docs/storage/vercel-blob/client-upload).

## [Prerequisites](https://vercel.com/docs/vercel-blob/server-upload?language=py#prerequisites)
...
1.  ### [Create a Blob store](https://vercel.com/docs/vercel-blob/server-upload?language=py#create-a-blob-store)
    Navigate to the [Project](https://vercel.com/docs/projects/overview) you'd like to add the blob store to. Select the Storage tab, then select the Connect Database button.
...
2.  ### [Prepare your local project](https://vercel.com/docs/vercel-blob/server-upload?language=py#prepare-your-local-project)
...
Server uploads are perfectly fine as long as you do not need to upload files larger than [4.5 MB on Vercel](https://vercel.com/docs/functions/runtimes#request-body-size). If you need to upload larger files, consider using [client uploads](https://vercel.com/docs/storage/vercel-blob/client-upload).

## [Upload a file using Server Actions](https://vercel.com/docs/vercel-blob/server-upload?language=py#upload-a-file-using-server-actions)
...
## [Upload a file using a server upload page and route](https://vercel.com/docs/vercel-blob/server-upload?language=py#upload-a-file-using-a-server-upload-page-and-route)
...
1.  ### [Create a server upload page](https://vercel.com/docs/vercel-blob/server-upload?language=py#create-a-server-upload-page)
...
2.  ### [Create a server upload route](https://vercel.com/docs/vercel-blob/server-upload?language=py#create-a-server-upload-route)
...
### [Testing your page](https://vercel.com/docs/vercel-blob/server-upload?language=py#testing-your-page)

1.  ### [Run your application locally](https://vercel.com/docs/vercel-blob/server-upload?language=py#run-your-application-locally)
...
2.  ### [Review the Blob object metadata](https://vercel.com/docs/vercel-blob/server-upload?language=py#review-the-blob-object-metadata)
...
## [Next steps](https://vercel.com/docs/vercel-blob/server-upload?language=py#next-steps)
...
[Previous Blob](https://vercel.com/docs/vercel-blob)[Next Client Uploads](https://vercel.com/docs/vercel-blob/client-upload)
...
- [Prerequisites](https://vercel.com/docs/vercel-blob/server-upload?language=py#prerequisites)
- [Create a Blob store](https://vercel.com/docs/vercel-blob/server-upload?language=py#create-a-blob-store)
- [Prepare your local project](https://vercel.com/docs/vercel-blob/server-upload?language=py#prepare-your-local-project)
- [Upload a file using Server Actions](https://vercel.com/docs/vercel-blob/server-upload?language=py#upload-a-file-using-server-actions)
- [Upload a file using a server upload page and route](https://vercel.com/docs/vercel-blob/server-upload?language=py#upload-a-file-using-a-server-upload-page-and-route)
- [Create a server upload page](https://vercel.com/docs/vercel-blob/server-upload?language=py#create-a-server-upload-page)
- [Create a server upload route](https://vercel.com/docs/vercel-blob/server-upload?language=py#create-a-server-upload-route)
- [Testing your page](https://vercel.com/docs/vercel-blob/server-upload?language=py#testing-your-page)
- [Run your application locally](https://vercel.com/docs/vercel-blob/server-upload?language=py#run-your-application-locally)
- [Review the Blob object metadata](https://vercel.com/docs/vercel-blob/server-upload?language=py#review-the-blob-object-metadata)
- [Next steps](https://vercel.com/docs/vercel-blob/server-upload?language=py#next-steps)
