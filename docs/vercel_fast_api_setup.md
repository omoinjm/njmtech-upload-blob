...
URL Source: https://vercel.com/docs/frameworks/backend/fastapi
...
[![Image 1: VercelLogotype](https://vercel.com/vc-ap-vercel-docs/_next/static/media/vercel-logotype-light.64164313.svg?dpl=dpl_33YfYJXpgX4k1UK3EXgtfrCmYzVs)![Image 2: VercelLogotype](https://vercel.com/vc-ap-vercel-docs/_next/static/media/vercel-logotype-dark.49dd0a95.svg?dpl=dpl_33YfYJXpgX4k1UK3EXgtfrCmYzVs)](https://vercel.com/home)

![Image 3: Vercel](https://vercel.com/vc-ap-vercel-docs/_next/static/media/vercel-light.cb298fd7.svg?dpl=dpl_33YfYJXpgX4k1UK3EXgtfrCmYzVs)![Image 4: Vercel](https://vercel.com/vc-ap-vercel-docs/_next/static/media/vercel-dark.d798e77e.svg?dpl=dpl_33YfYJXpgX4k1UK3EXgtfrCmYzVs)
...
## [Get started with FastAPI on Vercel](https://vercel.com/docs/frameworks/backend/fastapi#get-started-with-fastapi-on-vercel)

You can quickly deploy a FastAPI application to Vercel by creating a FastAPI app or using an existing one:

[![Image 5](https://api-frameworks.vercel.sh/framework-logos/fastapi.svg)Deploy FastAPI to Vercel](https://vercel.com/templates/python/fastapi-python-boilerplate)

[Deploy](https://vercel.com/new/clone?repository-url=https%3A%2F%2Fgithub.com%2Fvercel%2Fvercel%2Ftree%2Fmain%2Fexamples%2Ffastapi&template=fastapi)[Live Example](https://vercel-plus-fastapi.vercel.app/)

### [Get started with Vercel CLI](https://vercel.com/docs/frameworks/backend/fastapi#get-started-with-vercel-cli)

Get started by initializing a new FastAPI project using [Vercel CLI init command](https://vercel.com/docs/cli/init):
...
## [Exporting the FastAPI application](https://vercel.com/docs/frameworks/backend/fastapi#exporting-the-fastapi-application)
...
### [Build command](https://vercel.com/docs/frameworks/backend/fastapi#build-command)
...
### [Local development](https://vercel.com/docs/frameworks/backend/fastapi#local-development)
...
### [Deploying the application](https://vercel.com/docs/frameworks/backend/fastapi#deploying-the-application)
...
## [Serving static assets](https://vercel.com/docs/frameworks/backend/fastapi#serving-static-assets)
...
## [Startup and shutdown](https://vercel.com/docs/frameworks/backend/fastapi#startup-and-shutdown)
...
## [Vercel Functions](https://vercel.com/docs/frameworks/backend/fastapi#vercel-functions)
...
## [Limitations](https://vercel.com/docs/frameworks/backend/fastapi#limitations)
...
## [More resources](https://vercel.com/docs/frameworks/backend/fastapi#more-resources)
...
[Previous Elysia](https://vercel.com/docs/frameworks/backend/elysia)[Next Fastify](https://vercel.com/docs/frameworks/backend/fastify)
